    ...
    JnGpuCatalogResolveReason reason )
{
    ...
    const auto resolved = ResolveJnGpuCatalogGenerationData( data, generation, anonymizeDescriptor );
    ...
    stats.totalUnresolved += resolved.totalUnresolved;
    stats.coreUnresolved += resolved.coreUnresolved;
    return { resolved.totalUnresolved, resolved.coreUnresolved };
