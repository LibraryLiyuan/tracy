...
Require ($coverage.schema_version -eq '1.35.0') 'Domain coverage schema is not 1.35.0.'
Require ($fields.schema_version -eq '1.35.0') 'Field coverage schema is not 1.35.0.'
Require ($mcpCoverage.schema_version -eq '1.35.0') 'MCP coverage schema is not 1.35.0.'
