...
public:
    ...
    {
        return {
            "JNCI1|{\"schema_version\":1,\"kind\":\"core\",\"producer\":\"jn-native-client\",\"identity\":{\"protocol\":{\"jn_abi_version\":\"0x00010000\",\"jn_config_hash\":\"0x8daf4c01004d0008\",\"tracy_protocol_version\":\"77\"}}}",
    ...
    std::vector<analysis::Capability> GetCapabilities() const override
    {
        ...
        for( const auto* domain : { "system", "trace", "capture", "thread", "cpu", "context_switch", "frame", "frame_image", "timeline", "zone.cpu", "zone.gpu", "callstack", "sample", "hardware_sample", "symbol", "source", "memory", "memory.gpu", "lock", "plot", "message", "job", "job.gfx", "statistics", "compare", "validation" } )
        {
