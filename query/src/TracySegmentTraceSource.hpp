...
public:
    ...
    std::vector<analysis::ResourceAssetUpdateDto> GetResourceAssetUpdates() const override;
    ...
    std::vector<analysis::ResourceContextDto> GetResourceContexts() const override;
    ...
    std::vector<analysis::ResourceQualityDto> GetResourceQuality() const override;
