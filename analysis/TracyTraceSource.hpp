...
struct ResourceAssetDto
{
    ...
    uint64_t idLow = 0;
    std::string threadRef;
    uint8_t identityNamespace = 0;
    uint8_t assetKind = 0;
    uint8_t flags = 0;
};

struct ResourceAssetUpdateDto
{
    std::string ref;
    uint64_t entityId = 0;
    uint64_t value = 0;
...
struct UnityObjectEventDto
{
    std::string ref;
    uint64_t objectId = 0;
    uint64_t nativePointer = 0;
    int64_t timeNs = 0;
    std::string threadRef;
    ...
    uint64_t value = 0;
    std::string text;
    uint16_t runtimeTypeIndex = 0;
    uint16_t fieldMask = 0;
    uint8_t eventKind = 0; // 1 create, 2 update, 3 destroy
    uint8_t flags = 0;
};

struct NativeRootDto
{
    std::string ref;
    uint64_t rootId = 0;
    uint64_t objectId = 0;
...
struct GfxResourceBindingDto
{
    std::string ref;
    uint64_t gfxResourceId = 0;
    uint64_t targetId = 0;
    int64_t timeNs = 0;
    std::string threadRef;
    uint32_t generation = 0;
    uint8_t targetKind = 0;
    uint8_t resourceKind = 0;
    uint8_t eventKind = 0; // 1 bind, 2 unbind
    uint8_t reason = 0;
    uint8_t flags = 0;
};

struct ResourcePartDto
{
    std::string ref;
    uint64_t partId = 0;
    uint64_t ownerId = 0;
    ...
    std::string threadRef;
    uint32_t index = 0;
    uint8_t semanticKind = 0;
    uint8_t ownerKind = 0;
    uint8_t flags = 0;
};

struct ResourceRangeDto
{
    std::string ref;
    uint64_t partId = 0;
    uint64_t targetId = 0;
...
struct ResourceContextDto
{
    std::string ref;
    uint64_t contextId = 0;
    uint64_t relatedId = 0;
    int64_t timeNs = 0;
    std::string threadRef;
    uint32_t callsiteId = 0;
    uint8_t relatedKind = 0;
    uint8_t stage = 0;
    uint8_t flags = 0;
};

struct ResourceMetadataDto
{
    std::string ref;
    uint64_t entityId = 0;
    uint64_t value = 0;
...
public:
    ...
    virtual std::vector<ResourceAssetDto> GetResourceAssets() const { return {}; }
    virtual std::vector<ResourceAssetUpdateDto> GetResourceAssetUpdates() const { return {}; }
    virtual std::vector<UnityObjectEventDto> GetUnityObjectEvents() const { return {}; }
    virtual std::vector<NativeRootDto> GetNativeRoots() const { return {}; }
    virtual std::vector<GfxResourceBindingDto> GetGfxResourceBindings() const { return {}; }
    virtual std::vector<ResourcePartDto> GetResourceParts() const { return {}; }
    virtual std::vector<ResourceRangeDto> GetResourceRanges() const { return {}; }
    virtual std::vector<ResourceContextDto> GetResourceContexts() const { return {}; }
    virtual std::vector<ResourceMetadataDto> GetResourceMetadata() const { return {}; }
    virtual std::vector<ResourceRelationDto> GetResourceRelations() const { return {}; }
    virtual std::vector<ResourceBootstrapDto> GetResourceBootstrapStates() const { return {}; }
    virtual std::vector<ResourceQualityDto> GetResourceQuality() const { return {}; }
