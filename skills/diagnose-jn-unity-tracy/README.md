...
> 当前版 2.2.0：按 [优先级与测试人员决策](references/priority-and-tester-review.md) 执行。Query 原 P1/P2/P3/P4 映射为新 P0/P1/P2/P3，用户关注进入新 P0，窗口类别留在新 P1；新 P1 先交证据候选报告，测试人员选择后源码深查。下文历史示例的原 P 级和完成要求须按此范围解释。
